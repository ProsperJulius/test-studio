...
(async () => {
  ...
  try {
    ...
    for (const id of ['TC006', 'TC007', 'TC008', 'TC009', 'TC010', 'TC013', 'TC014', 'TC015', 'TC016', 'TC018', 'TC019']) assert.equal(byId[id].status, 'Passed', id + ': ' + JSON.stringify(byId[id].failure));
    ...
    assert.match(junit, /tests="19" failures="4"/);
